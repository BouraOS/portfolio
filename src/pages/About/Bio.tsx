      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-3 lg:col-span-2 rounded-xl px-10 pt-3 ">
          ...
          <p className="text-lg text-muted-foreground">
            ...
            intuitive and responsive web and mobile applications. With expertise
            in React.js, Angular, and React Native, I focus on delivering
            high-quality solutions tailored to user needs.
          </p>
          <p className="text-lg text-muted-foreground mt-3">
            As a freelancer, I thrive on building innovative projects and
