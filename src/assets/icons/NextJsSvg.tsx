function IconNextJs({ width, height }: { width?: number; height?: number }) {
  return (
    <svg
      ...
      <g mask="url(#logosNextjsIcon3)">
        ...
        <path
          ...
          d="M212.634 224.028L98.335 76.8H76.8v102.357h17.228V98.68L199.11 234.446a128 128 0 0 0 13.524-10.418"></path>
